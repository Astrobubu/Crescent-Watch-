...
const translations = {
    ...
    ar: {
        ...
        'about.calculations_desc': 'تعتمد تنبؤات الرؤية على معياري يالوب (1997) وأوده (2006) القياسيين، باستخدام خوارزميات فلكية دقيقة لموضع القمر والارتفاع الطبوغرافي والاستطالة.',
